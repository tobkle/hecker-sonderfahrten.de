...
const datenschutz = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <main className="flex flex-col items-center justify-center text-left p-8">
                <section id="datenschutz" className="pt-32 prose lg:prose-xl">
                    <div className="text-base leading-6 uppercase font-semibold text-blue-400">
                        HECKER SONDERFAHRTEN E.K.
                    </div>
                    <h1 className="pt-2 pb-8 text-4xl leading-10 font-extrabold">
                    ...
                    <p>
                        Hecker Sonderfahrten e.K. <br /> Telefon:{" "}
                        <span class="phone ">07951 / 3198270</span> <br />
                        E-Mail:{" "}
                        <a
                            href="mailto:info@hecker-sonderfahrten.de"
                            class="escape email "
                            title="Schreiben Sie Hecker Sonderfahrten e.K. in 74564 Crailsheim eine E-Mail."
                            data-email='{"name":"info","host":"hecker-sonderfahrten.de"}'
                        >
                    ...
                    <p>
                        <strong>
                            ...
                            besonderen Situation ergeben, gegen die Verarbeitung
                            ...
                            oder Verteidigung von Rechtsansprüchen (Widerspruch
                    ...
                    <p>
                        <strong>
                            ...
                            in Verbindung steht. Wenn Sie widersprechen, werden
                            Ihre personenbezogenen Daten anschließend nicht mehr
                            zum Zwecke der Direktwerbung verwendet (Widerspruch
                    ...
                    <p>
                        ...
                        Vertrags eine Verpflichtung, uns Ihre Zahlungsdaten
                        (z.&nbsp;B. Kontonummer bei Einzugsermächtigung) zu
                        übermitteln, werden diese Daten zur Zahlungsabwicklung
                        benötigt. Der Zahlungsverkehr über die gängigen
                        Zahlungsmittel (Visa/MasterCard, Lastschriftverfahren)
                        erfolgt ausschließlich über eine verschlüsselte SSL-
                        bzw. TLS-Verbindung. Eine verschlüsselte Verbindung
                        erkennen Sie daran, dass die Adresszeile des Browsers
                        von „http://“ auf „https://“ wechselt und an dem
                    ...
                    <p>
                        ...
                        wir nicht ohne Ihre Einwilligung weiter. Die
                    ...
                    <p>
                        ...
                        Anliegens). Zwingende gesetzliche Bestimmungen –
                    ...
                    <p>
                        Wir übermitteln personenbezogene Daten an Dritte nur
                        dann, wenn dies im Rahmen der Vertragsabwicklung
                        notwendig ist, etwa an die mit der Lieferung der Ware
                        betrauten Unternehmen oder das mit der
                        Zahlungsabwicklung beauftragte Kreditinstitut. Eine
                        weitergehende Übermittlung der Daten erfolgt nicht bzw.
                        nur dann, wenn Sie der Übermittlung ausdrücklich
                    ...
                    <p>
                        Wir übermitteln personenbezogene Daten an Dritte nur
                        dann, wenn dies im Rahmen der Vertragsabwicklung
                        notwendig ist, etwa an das mit der Zahlungsabwicklung
                        beauftragte Kreditinstitut. Eine weitergehende
                        Übermittlung der Daten erfolgt nicht bzw. nur dann, wenn
                        Sie der Übermittlung ausdrücklich zugestimmt haben. Eine
                    ...
                    <p>
                        ...
                        können Sie sich mit Facebook Connect registrieren.
                        Anbieter dieses Dienstes ist die Facebook Ireland
                        Limited, 4 Grand Canal Square, Dublin 2, Irland.
                    </p>{" "}
                    <p>
                        Wenn Sie sich für die Registrierung mit Facebook Connect
                        entscheiden und auf den „Login with Facebook“-/„Connect
                        with Facebook“-Button klicken, werden Sie automatisch
                        auf die Plattform von Facebook weitergeleitet. Dort
                        können Sie sich mit Ihren Nutzungsdaten anmelden.
                        Dadurch wird Ihr Facebook-Profil mit unserer Website
                        bzw. unseren Diensten verknüpft. Durch diese Verknüpfung
                        erhalten wir Zugriff auf Ihre bei Facebook hinterlegten
                    ...
                    <ul>
                        ...
                        <li>Geburtstag</li> <li>Geschlecht</li> <li>Land</li>{" "}
                        <li>Sprache</li>{" "}
                    </ul>{" "}
                    <p>
                    ...
                    <p>
                        Die Registrierung mit Facebook-Connect und die damit
                        verbundenen Datenverarbeitungsvorgänge erfolgen auf
                        Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a
                        DSGVO). Diese Einwilligung können Sie jederzeit mit
                        Wirkung für die Zukunft widerrufen.
                    </p>{" "}
                    <p>
                        Weitere Informationen finden Sie in den
                        Facebook-Nutzungsbedingungen und den
                        Facebook-Datenschutzbestimmungen. Diese finden Sie
                        unter:{" "}
                        <a
                    ...
                    <p>
                        ...
                        Ihrem Kommentar auch Angaben zum Zeitpunkt der
                        Erstellung des Kommentars, Ihre E-Mail-Adresse und, wenn
                        Sie nicht anonym posten, der von Ihnen gewählte
                    ...
                    <p>
                        ...
                        Bestätigungsemail, um zu prüfen, ob Sie der Inhaber der
                        angegebenen E-Mail-Adresse sind. Sie können diese
                        Funktion jederzeit über einen Link in den Info-Mails
                        abbestellen. Die im Rahmen des Abonnierens von
                        Kommentaren eingegebenen Daten werden in diesem Fall
                        gelöscht; wenn Sie diese Daten für andere Zwecke und an
                        anderer Stelle (z.B. Newsletterbestellung) an uns
                        übermittelt haben, verbleiben die jedoch bei uns.
                    </p>{" "}
                    <h6>Speicherdauer der Kommentare</h6>{" "}
                    <p>
                        Die Kommentare und die damit verbundenen Daten
                        (z.&nbsp;B. IP-Adresse) werden gespeichert und
                        verbleiben auf unserer Website, bis der kommentierte
                        Inhalt vollständig gelöscht wurde oder die Kommentare
                    ...
                    <p>
                        ...
                        Maps. Anbieter ist die Google Ireland Limited
                    ...
                    <h5>Adobe Fonts</h5>{" "}
                    <p>
                        Unsere Website nutzt zur einheitlichen Darstellung
                        bestimmter Schriftarten Web Fonts von Adobe. Anbieter
                        ist die Adobe Systems Incorporated, 345 Park Avenue, San
                        Jose, CA 95110-2704, USA (Adobe).
                    </p>{" "}
                    <p>
                        Beim Aufruf unserer Seiten lädt Ihr Browser die
                        benötigten Schriftarten direkt von Adobe, um sie Ihrem
                        Endgerät korrekt anzeigen zu können. Dabei stellt Ihr
                        Browser eine Verbindung zu den Servern von Adobe in den
                        USA her. Hierdurch erlangt Adobe Kenntnis darüber, dass
                        über Ihre IP-Adresse unsere Website aufgerufen wurde.
                        Bei der Bereitstellung der Schriftarten werden nach
                        Aussage von Adobe keine Cookies gespeichert.
                    </p>{" "}
                    <p>
                        Adobe verfügt über eine Zertifizierung nach dem
                        EU-US-Privacy-Shield. Der Privacy-Shield ist ein
                        Abkommen zwischen den Vereinigten Staaten von Amerika
                        und der Europäischen Union, das die Einhaltung
                        europäischer Datenschutzstandards gewährleisten soll.
                    ...
                    <p>
                        Die Nutzung von Adobe Fonts ist erforderlich, um ein
                        einheitliches Schriftbild auf unserer Website zu
                        gewährleisten. Dies stellt ein berechtigtes Interesse im
                        Sinne des Art. 6 Abs. 1 lit. f DSGVO dar.
                    </p>{" "}
                    <p>
                    ...
                    <p>
                        Unsere Website nutzt Plugins der Website YouTube.
                    ...
                    <p>
                        ...
                        Dieser Modus bewirkt laut YouTube, dass YouTube keine
                        Informationen über die Besucher auf dieser Website
                        speichert, bevor diese sich das Video ansehen. Die
                        Weitergabe von Daten an YouTube-Partner wird durch den
                        erweiterten Datenschutzmodus hingegen nicht zwingend
                        ausgeschlossen. So stellt YouTube – unabhängig davon, ob
                        Sie sich ein Video ansehen – eine Verbindung zum Google
                        DoubleClick-Netzwerk her.
                    </p>{" "}
                    <p>
                        Sobald Sie ein YouTube-Video auf unserer Website
                        starten, wird eine Verbindung zu den Servern von YouTube
                        hergestellt. Dabei wird dem YouTube-Server mitgeteilt,
                        welche unserer Seiten Sie besucht haben. Wenn Sie in
                        Ihrem YouTube-Account eingeloggt sind, ermöglichen Sie
                    ...
                    <p>
                        ...
                        verschiedene Cookies auf Ihrem Endgerät speichern. Mit
                        Hilfe dieser Cookies kann YouTube Informationen über
                        Besucher unserer Website erhalten. Diese Informationen
                        werden u. a. verwendet, um Videostatistiken zu erfassen,
                        die Anwenderfreundlichkeit zu verbessern und
                        Betrugsversuchen vorzubeugen. Die Cookies verbleiben auf
                        Ihrem Endgerät, bis Sie sie löschen.
                    </p>{" "}
                    <p>
                        Gegebenenfalls können nach dem Start eines
                        YouTube-Videos weitere Datenverarbeitungsvorgänge
                    ...
                    <p>
                        ...
                        finden Sie in deren Datenschutzerklärung unter:{" "}
                        <a
                            href="https://policies.google.com/privacy?hl=de"
                            target="_blank"
                            rel="noopener"
                    ...
                    <p>
                        ...
                        Anbieter ist die Vimeo Inc., 555 West 18th Street, New
                    ...
                    <p>
                        ...
                        den Servern von Vimeo hergestellt. Dabei wird dem
                        Vimeo-Server mitgeteilt, welche unserer Seiten Sie
                        besucht haben. Zudem erlangt Vimeo Ihre IP-Adresse. Dies
                        gilt auch dann, wenn Sie nicht bei Vimeo eingeloggt sind
                        oder keinen Account bei Vimeo besitzen. Die von Vimeo
                        erfassten Informationen werden an den Vimeo-Server in
                        den USA übermittelt.
                    </p>{" "}
                    <p>
                        Wenn Sie in Ihrem Vimeo-Account eingeloggt sind,
                        ermöglichen Sie Vimeo, Ihr Surfverhalten direkt Ihrem
                        persönlichen Profil zuzuordnen. Dies können Sie
                        verhindern, indem Sie sich aus Ihrem Vimeo-Account
                        ausloggen.
                    </p>{" "}
                    <p>
                        Die Nutzung von Vimeo erfolgt im Interesse einer
                        ansprechenden Darstellung unserer Online-Angebote. Dies
                        stellt ein berechtigtes Interesse im Sinne des Art. 6
                        Abs. 1 lit. f DSGVO dar.
                    </p>{" "}
                    <p>
                        Weitere Informationen zum Umgang mit Nutzerdaten finden
                        Sie in der Datenschutzerklärung von Vimeo unter:{" "}
                        <a
                    ...
                    <p>
                        ...
                        SoundCloud (SoundCloud Limited, Berners House, 47-48
                        Berners Street, London W1T 3NF, Großbritannien.)
                        integriert sein. Die SoundCloud-Plugins erkennen Sie an
                        dem SoundCloud-Logo auf den betroffenen Seiten.
                    </p>{" "}
                    <p>
                        Wenn Sie unsere Seiten besuchen, wird nach Aktivierung
                        des Plugin eine direkte Verbindung zwischen Ihrem
                        Browser und dem SoundCloud-Server hergestellt.
                        SoundCloud erhält dadurch die Information, dass Sie mit
                        Ihrer IP-Adresse unsere Seite besucht haben. Wenn Sie
                        den „Like-Button“ oder „Share-Button“ anklicken während
                        Sie in Ihrem SoundCloud- Benutzerkonto eingeloggt sind,
                        können Sie die Inhalte unserer Seiten mit Ihrem
                        SoundCloud-Profil verlinken und/oder teilen. Dadurch
                        kann SoundCloud Ihrem Benutzerkonto den Besuch unserer
                        Seiten zuordnen. Wir weisen darauf hin, dass wir als
                        Anbieter der Seiten keine Kenntnis vom Inhalt der
                        übermittelten Daten sowie deren Nutzung durch SoundCloud
                        erhalten.
                    </p>{" "}
                    <p>
                        Die Nutzung von SoundCloud erfolgt auf Grundlage des
                    ...
                    <p>
                        Wenn Sie nicht wünschen, dass SoundCloud den Besuch
                        unserer Seiten Ihrem SoundCloud- Benutzerkonto zuordnet,
                        loggen Sie sich bitte aus Ihrem SoundCloud-Benutzerkonto
                        aus bevor Sie Inhalte des SoundCloud-Plugins aktivieren.
                    </p>{" "}
                    <h5>Spotify</h5>{" "}
                    <p>
                        Auf unseren Seiten sind Funktionen des Musik-Dienstes
                        Spotify eingebunden. Anbieter ist die Spotify AB, Birger
                        Jarlsgatan 61, 113 56 Stockholm in Schweden. Die Spotify
                        Plugins erkennen Sie an dem grünen Logo auf unserer
                        Seite. Eine Übersicht über die Spotify-Plugins finden
                        Sie unter:{" "}
                        <a
                    ...
                    <p>
                        Dadurch kann beim Besuch unserer Seiten über das Plugin
                        eine direkte Verbindung zwischen Ihrem Browser und dem
                        Spotify-Server hergestellt werden. Spotify erhält
                        dadurch die Information, dass Sie mit Ihrer IP-Adresse
                        unsere Seite besucht haben. Wenn Sie den Spotify Button
                        anklicken während Sie in Ihrem Spotify-Account
                        eingeloggt sind, können Sie die Inhalte unserer Seiten
                    ...
                    <p>
                        Wenn Sie nicht wünschen, dass Spotify den Besuch unserer
                        Seiten Ihrem Spotify-Nutzerkonto zuordnen kann, loggen
                        Sie sich bitte aus Ihrem Spotify-Benutzerkonto aus.
                    </p>{" "}
                    <h5>Zendesk</h5>{" "}
                    <p>
                        Zur Bearbeitung von Nutzeranfragen verwenden wir das
                        CRM-System Zendesk. Anbieter ist die Zendesk, Inc, 1019
                        Market Street in San Francisco, CA 94103 USA.
                    </p>{" "}
                    <p>
                        Wir nutzen Zendesk, um Ihre Anfragen schnell und
                        effizient bearbeiten zu können. Rechtsgrundlage für die
                        Verarbeitung Ihrer Daten ist das berechtigte Interesse
                        auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
                    </p>{" "}
                    <p>
                        Zendesk ist als US-amerikanischer Anbieter
                        Privacy-Shield zertifiziert und verpflichtet sich
                        dadurch, das Datenschutzrecht der EU einzuhalten.
                        Zusätzlich haben wir mit Zendesk einen Vertrag über
                        Auftragsverarbeitung (Data Processing Agreement, DPA)
                        abgeschlossen. Dadurch ist sichergestellt, dass Zendesk
                        die Nutzer-Daten nur im Rahmen der EU-Datenschutznormen
                        ausschließlich zur Verarbeitung der Anfragen nutzt und
                        diese nicht an Dritte weiter gibt.
                    </p>{" "}
                    <p>
                    ...
                    <p>
                        Sollten Sie nicht mit der Bearbeitung Ihrer Anfrage bei
                        uns über Zendesk einverstanden sein, können Sie
                        alternativ per E-Mail, Telefon oder Fax mit uns
                        kommunizieren.
                    </p>{" "}
                    <p>
                    ...
                    <p>
                        ...
                        auf unseren Websites. Anbieter ist die Google Ireland
                        Limited („Google“), Gordon House, Barrow Street, Dublin
                        4, Irland.
                    </p>{" "}
                    <p>
                        Mit reCAPTCHA soll überprüft werden, ob die Dateneingabe
                        auf unseren Websites (z.&nbsp;B. in einem
                        ...
                        Informationen aus (z.&nbsp;B. IP-Adresse, Verweildauer
                        des Websitebesuchers auf der Website oder vom Nutzer
                    ...
                    <p>
                        Auf unseren Seiten werden Plugins von sozialen Medien
                        verwendet (z.&nbsp;B. Facebook, Twitter, Google+,
                        Instagram, Pinterest, XING, LinkedIn, Tumblr).
                    </p>{" "}
                    <p>
                        Die Plugins können Sie in der Regel anhand der
                        jeweiligen Social-Media-Logos erkennen. Um den
                        Datenschutz auf unserer Website zu gewährleisten,
                        verwenden wir diese Plugins nur zusammen mit der
                        sogenannten „Shariff“-Lösung. Diese Anwendung
                        verhindert, dass die auf unserer Website integrierten
                        Plugins Daten schon beim ersten Betreten der Seite an
                        den jeweiligen Anbieter übertragen.
                    </p>{" "}
                    <p>
                        Erst wenn Sie das jeweilige Plugin durch Anklicken der
                        zugehörigen Schaltfläche aktivieren, wird eine direkte
                        Verbindung zum Server des Anbieters hergestellt
                        (Einwilligung). Sobald Sie das Plugin aktivieren, erhält
                        der jeweilige Anbieter die Information, dass Sie mit
                        Ihrer IP-Adresse unsere Seite besucht haben. Wenn Sie
                        gleichzeitig in Ihrem jeweiligen Social-Media-Account
                        (z.&nbsp;B. Facebook) eingeloggt sind, kann der
                        jeweilige Anbieter den Besuch unserer Seiten Ihrem
                        Benutzerkonto zuordnen.
                    </p>{" "}
                    <p>
                        Das Aktivieren des Plugins stellt eine Einwilligung im
                        Sinne des Art. 6 Abs. 1 lit. a DSGVO dar. Diese
                        Einwilligung können Sie jederzeit mit Wirkung für die
                        Zukunft widerrufen.
                    </p>{" "}
                    ...
                    <p>
                        ...
                        besucht haben. Wenn Sie den Facebook „Like-Button“
                        anklicken während Sie in Ihrem Facebook-Account
                        eingeloggt sind, können Sie die Inhalte unserer Seiten
                        auf Ihrem Facebook-Profil verlinken. Dadurch kann
                        Facebook den Besuch unserer Seiten Ihrem Benutzerkonto
                        zuordnen. Wir weisen darauf hin, dass wir als Anbieter
                        der Seiten keine Kenntnis vom Inhalt der übermittelten
                    ...
                    <p>
                        ...
                        aus. Die Verwendung der Facebook Plugins erfolgt auf
                        Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
                        Websitebetreiber hat ein berechtigtes Interesse an einer
                        möglichst umfangreichen Sichtbarkeit in den Sozialen
                        Medien.
                    </p>{" "}
                    ...
                    <p>
                        ...
                        <a
                            ...
                            title="Einsatz von juicer.io"
                        >
                            https://www.juicer.io
                        </a>{" "}
                        zum Anzeigen diverser Posts aus Social media Portalen.
                        Juicer selbst sammelt keine persönlichen Daten der
                        Besucher die diesen Feed besuchen. Details können Sie in
                        der Privacy Policy von Juicer nachlesen:{" "}
                        <a
                    ...
                    <p>
                        ...
                        Francisco, CA 94103, USA. Durch das Benutzen von Twitter
                        und der Funktion „Re-Tweet“ werden die von Ihnen
                        besuchten Websites mit Ihrem Twitter-Account verknüpft
                        und anderen Nutzern bekannt gegeben. Dabei werden auch
                        Daten an Twitter übertragen. Wir weisen darauf hin, dass
                        wir als Anbieter der Seiten keine Kenntnis vom Inhalt
                        der übermittelten Daten sowie deren Nutzung durch
                    ...
                    <p>
                        Die Verwendung des Twitter-Plugins erfolgt auf Grundlage
                        von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
                        ein berechtigtes Interesse an einer möglichst
                        umfangreichen Sichtbarkeit in den Sozialen Medien. Ihre
                    ...
                    <p>
                        ...
                        veröffentlichen. Über die Google+-Schaltfläche erhalten
                        Sie und andere Nutzer personalisierte Inhalte von Google
                        und unseren Partnern. Google speichert sowohl die
                        Information, dass Sie für einen Inhalt +1 gegeben haben,
                        als auch Informationen über die Seite, die Sie beim
                        Klicken auf +1 angesehen haben. Ihre +1 können als
                        Hinweise zusammen mit Ihrem Profilnamen und Ihrem Foto
                        in Google-Diensten, wie etwa in Suchergebnissen oder in
                        Ihrem Google-Profil, oder an anderen Stellen auf
                        Websites und Anzeigen im Internet eingeblendet werden.
                    </p>{" "}
                    <p>
                        Google zeichnet Informationen über Ihre +1-Aktivitäten
                        auf, um die Google-Dienste für Sie und andere zu
                        verbessern. Um die Google+-Schaltfläche verwenden zu
                        können, benötigen Sie ein weltweit sichtbares,
                        öffentliches Google-Profil, das zumindest den für das
                        Profil gewählten Namen enthalten muss. Dieser Name wird
                        in allen Google-Diensten verwendet. In manchen Fällen
                        kann dieser Name auch einen anderen Namen ersetzen, den
                        Sie beim Teilen von Inhalten über Ihr Google-Konto
                        verwendet haben. Die Identität Ihres Google-Profils kann
                        Nutzern angezeigt werden, die Ihre E-Mail-Adresse kennen
                        oder über andere identifizierende Informationen von
                        Ihnen verfügen.
                    </p>{" "}
                    <p>
                        ...
                        veröffentlicht möglicherweise zusammengefasste
                        Statistiken über die +1-Aktivitäten der Nutzer bzw. gibt
                        diese an Nutzer und Partner weiter, wie etwa Publisher,
                        Inserenten oder verbundene Websites. Die Verwendung des
                        Google+-Plugins erfolgt auf Grundlage von Art. 6 Abs. 1
                        lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes
                        Interesse an einer möglichst umfangreichen Sichtbarkeit
                        in den Sozialen Medien.
                    </p>{" "}
                    <h5>Instagram Plugin</h5>{" "}
                    <p>
                        Auf unseren Seiten sind Funktionen des Dienstes
                        Instagram eingebunden. Diese Funktionen werden angeboten
                        durch die Instagram Inc., 1601 Willow Road, Menlo Park,
                        CA 94025, USA integriert.
                    </p>{" "}
                    <p>
                        Wenn Sie in Ihrem Instagram-Account eingeloggt sind,
                        können Sie durch Anklicken des Instagram-Buttons die
                        Inhalte unserer Seiten mit Ihrem Instagram-Profil
                        verlinken. Dadurch kann Instagram den Besuch unserer
                        Seiten Ihrem Benutzerkonto zuordnen. Wir weisen darauf
                        hin, dass wir als Anbieter der Seiten keine Kenntnis vom
                        Inhalt der übermittelten Daten sowie deren Nutzung durch
                        Instagram erhalten.
                    </p>{" "}
                    <p>
                        Die Verwendung des Instagram-Plugins erfolgt auf
                        Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
                        Websitebetreiber hat ein berechtigtes Interesse an einer
                        möglichst umfangreichen Sichtbarkeit in den Sozialen
                        Medien.
                    ...
                    <p>
                        ...
                        Anbieter ist die Tumblr, Inc., 35 East 21st St, 10th
                        Floor, New York, NY 10010, USA.
                    </p>{" "}
                    <p>
                        Diese Schaltflächen ermöglichen es Ihnen, einen Beitrag
                        oder eine Seite bei Tumblr zu teilen oder dem Anbieter
                        bei Tumblr zu folgen. Wenn Sie eine unserer Websites mit
                        Tumblr-Button aufrufen, baut der Browser eine direkte
                        Verbindung mit den Servern von Tumblr auf. Wir haben
                        keinen Einfluss auf den Umfang der Daten, die Tumblr mit
                        Hilfe dieses Plugins erhebt und übermittelt. Nach
                        aktuellem Stand werden die IP-Adresse des Nutzers sowie
                        die URL der jeweiligen Website übermittelt.
                    </p>{" "}
                    <p>
                        Die Verwendung des Tumblr-Plugins erfolgt auf Grundlage
                        von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
                        ein berechtigtes Interesse an einer möglichst
                    ...
                    <p>
                        ...
                        Anbieter ist die LinkedIn Corporation, 2029 Stierlin
                        Court, Mountain View, CA 94043, USA.
                    </p>{" "}
                    <p>
                        Bei jedem Abruf einer unserer Seiten, die Funktionen von
                        LinkedIn enthält, wird eine Verbindung zu Servern von
                        LinkedIn aufgebaut. LinkedIn wird darüber informiert,
                        dass Sie unsere Internetseiten mit Ihrer IP-Adresse
                        besucht haben. Wenn Sie den „Recommend-Button“ von
                        LinkedIn anklicken und in Ihrem Account bei LinkedIn
                        eingeloggt sind, ist es LinkedIn möglich, Ihren Besuch
                        auf unserer Internetseite Ihnen und Ihrem Benutzerkonto
                        zuzuordnen. Wir weisen darauf hin, dass wir als Anbieter
                        der Seiten keine Kenntnis vom Inhalt der übermittelten
                        Daten sowie deren Nutzung durch LinkedIn haben.
                    </p>{" "}
                    <p>
                        Die Verwendung des LinkedIn-Plugins erfolgt auf
                        Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
                        Websitebetreiber hat ein berechtigtes Interesse an einer
                        möglichst umfangreichen Sichtbarkeit in den Sozialen
                        Medien.
                    ...
                    <p>
                        Bei jedem Abruf einer unserer Seiten, die Funktionen von
                        XING enthält, wird eine Verbindung zu Servern von XING
                        hergestellt. Eine Speicherung von personenbezogenen
                        Daten erfolgt dabei nach unserer Kenntnis nicht.
                        Insbesondere werden keine IP-Adressen gespeichert oder
                        das Nutzungsverhalten ausgewertet.
                    </p>{" "}
                    <p>
                        Die Verwendung des XING-Plugins erfolgt auf Grundlage
                        von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
                        ein berechtigtes Interesse an einer möglichst
                        umfangreichen Sichtbarkeit in den Sozialen Medien.
                    </p>{" "}
                    <p>
                        ...
                        Share-Button finden Sie in der Datenschutzerklärung von
                        XING unter:{" "}
                        <a
                    ...
                    <p>
                        Auf unserer Seite verwenden wir Social Plugins des
                        sozialen Netzwerkes Pinterest, das von der Pinterest
                        Inc., 808 Brannan Street, San Francisco, CA 94103-490,
                        USA („Pinterest“) betrieben wird.
                    </p>{" "}
                    <p>
                        Wenn Sie eine Seite aufrufen, die ein solches Plugin
                        enthält, stellt Ihr Browser eine direkte Verbindung zu
                        den Servern von Pinterest her. Das Plugin übermittelt
                        dabei Protokolldaten an den Server von Pinterest in die
                        USA. Diese Protokolldaten enthalten möglicherweise Ihre
                        IP-Adresse, die Adresse der besuchten Websites, die
                        ebenfalls Pinterest-Funktionen enthalten, Art und
                        Einstellungen des Browsers, Datum und Zeitpunkt der
                        Anfrage, Ihre Verwendungsweise von Pinterest sowie
                        Cookies.
                    </p>{" "}
                    <p>
                        Die Verwendung des Pinterest-Plugins erfolgt auf
                        Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
                        Websitebetreiber hat ein berechtigtes Interesse an einer
                        möglichst umfangreichen Sichtbarkeit in den Sozialen
                        Medien.
                    ...
                    <p>
                        ...
                        Ihre diesbezüglichen Rechte und Möglichkeiten zum Schutz
                    ...
                    <h5>Hotjar</h5>{" "}
                    <p>
                        Diese Website nutzt Hotjar. Anbieter ist die Hotjar
                        Ltd., Level 2, St Julians Business Centre, 3, Elia
                        Zammit Street, St Julians STJ 1000, Malta, Europe
                        (Website:{" "}
                        <a
                    ...
                    <p>
                        Hotjar ist ein Werkzeug zur Analyse Ihres
                        Nutzerverhaltens auf unserer Website. Mit Hotjar können
                        wir u. a. Ihre Maus- und Scrollbewegungen und Klicks
                        aufzeichnen. Hotjar kann dabei auch feststellen, wie
                        lange Sie mit dem Mauszeiger auf einer bestimmten Stelle
                        verblieben sind. Aus diesen Informationen erstellt
                        Hotjar sogenannte Heatmaps, mit denen sich feststellen
                        lässt, welche Websitebereiche vom Websitebesucher
                        bevorzugt angeschaut werden.
                    </p>{" "}
                    <p>
                        Des Weiteren können wir feststellen, wie lange Sie auf
                        einer Seite verblieben sind und wann Sie sie verlassen
                        haben. Wir können auch feststellen, an welcher Stelle
                        Sie Ihre Eingaben in ein Kontaktformular abgebrochen
                        haben (sog. Conversion-Funnels).
                    </p>{" "}
                    <p>
                        Darüber hinaus können mit Hotjar direkte Feedbacks von
                        Websitebesuchern eingeholt werden. Diese Funktion dient
                        der Verbesserung der Webangebote des Websitebetreibers.
                    </p>{" "}
                    <p>
                        Hotjar verwendet Cookies. Cookies sind kleine
                        Textdateien, die auf Ihrem Rechner abgelegt werden und
                        die Ihr Browser speichert. Sie dienen dazu, unser
                        Angebot nutzerfreundlicher, effektiver und sicherer zu
                        machen. Mit diesen Cookies lässt sich insbesondere
                        feststellen, ob unsere Website mit einem bestimmten
                        Endgerät besucht wurde oder ob die Funktionen von Hotjar
                        für den betreffenden Browser deaktiviert wurde.
                        Hotjar-Cookies verbleiben auf Ihrem Endgerät, bis Sie
                        sie löschen.
                    </p>{" "}
                    <p>
                        Sie können Ihren Browser so einstellen, dass Sie über
                    ...
                    <p>
                        Die Nutzung von Hotjar und die Speicherung von
                        Hotjar-Cookies erfolgt auf Grundlage von Art. 6 Abs. 1
                        lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes
                    ...
                    <p>
                        Wenn Sie die Datenerfassung durch Hotjar deaktivieren
                        möchten, klicken Sie auf folgenden Link und folgen Sie
                    ...
                    <p>
                        Bitte beachten Sie, dass die Deaktivierung von Hotjar
                        für jeden Browser bzw. für jedes Endgerät separat
                        erfolgen muss.
                    </p>{" "}
                    <p>
                        Nähere Informationen über Hotjar und zu den erfassten
                        Daten entnehmen Sie der Datenschutzerklärung von Hotjar
                    ...
                    <p>
                        Wir haben einen Vertrag über Auftragsverarbeitung mit
                        Hotjar geschlossen, um die strengen europäischen
                        Datenschutzvorschriften umzusetzen.
                    </p>{" "}
                    <h5>Google Analytics</h5>{" "}
                    <p>
                        Diese Website nutzt Funktionen des Webanalysedienstes
                        Google Analytics. Anbieter ist die Google Ireland
                        Limited („Google“), Gordon House, Barrow Street, Dublin
                        4, Irland.
                    </p>{" "}
                    <p>
                    ...
                    <p>
                        ...
                        Website verhindert:{" "}
                        <a href="javascript:gaOptout();" title="Widerspruch">
                    ...
                    <p>
                        ...
                        Ereignisebene, die mit Cookies, Nutzerkennungen
                        (z.&nbsp;B. User ID) oder Werbe-IDs (z.&nbsp;B.
                        DoubleClick-Cookies, Android-Werbe-ID) verknüpft sind,
                        werden nach 14 Monaten anonymisiert bzw. gelöscht.
                    ...
                    <p>
                        ...
                        Analytics Remarketing in Verbindung mit den
                        geräteübergreifenden Funktionen von Google AdWords und
                        Google DoubleClick. Anbieter ist die Google Ireland
                        Limited („Google“), Gordon House, Barrow Street, Dublin
                        4, Irland.
                    </p>{" "}
                    <p>
                        ...
                        Surfverhaltens auf einem Endgerät (z.&nbsp;B. Handy) an
                        Sie angepasst wurden auch auf einem anderen Ihrer
                        Endgeräte (z.&nbsp;B. Tablet oder PC) angezeigt werden.
                    </p>{" "}
                    <p>
                        Haben Sie eine entsprechende Einwilligung erteilt,
                        verknüpft Google zu diesem Zweck Ihren Web- und
                        App-Browserverlauf mit Ihrem Google-Konto. Auf diese
                        Weise können auf jedem Endgerät auf dem Sie sich mit
                        Ihrem Google-Konto anmelden, dieselben personalisierten
                        Werbebotschaften geschaltet werden.
                    </p>{" "}
                    <p>
                        Zur Unterstützung dieser Funktion erfasst Google
                        Analytics google-authentifizierte IDs der Nutzer, die
                        vorübergehend mit unseren Google-Analytics-Daten
                        verknüpft werden, um Zielgruppen für die
                        geräteübergreifende Anzeigenwerbung zu definieren und zu
                        erstellen.
                    </p>{" "}
                    <p>
                        Sie können dem geräteübergreifenden
                        Remarketing/Targeting dauerhaft widersprechen, indem Sie
                        personalisierte Werbung deaktivieren; folgen Sie hierzu
                        diesem Link:{" "}
                        <a
                    ...
                    <p>
                        Die Zusammenfassung der erfassten Daten in Ihrem
                        Google-Konto erfolgt ausschließlich auf Grundlage Ihrer
                        Einwilligung, die Sie bei Google abgeben oder widerrufen
                        können (Art. 6 Abs. 1 lit. a DSGVO). Bei
                        Datenerfassungsvorgängen, die nicht in Ihrem
                        Google-Konto zusammengeführt werden (z.&nbsp;B. weil Sie
                        kein Google-Konto haben oder der Zusammenführung
                        widersprochen haben) beruht die Erfassung der Daten auf
                        Art. 6 Abs. 1 lit. f DSGVO. Das berechtigte Interesse
                        ergibt sich daraus, dass der Websitebetreiber ein
                        Interesse an der anonymisierten Analyse der
                        Websitebesucher zu Werbezwecken hat.
                    </p>{" "}
                    <p>
                        Weitergehende Informationen und die
                        Datenschutzbestimmungen finden Sie in der
                    ...
                    <p>
                        ...
                        sogenannte "Cookies", Textdateien, die auf Ihrem
                        Computer gespeichert werden und die eine Analyse der
                        Benutzung der Website ermöglichen. Google AdSense
                        verwendet auch so genannte Web Beacons (unsichtbare
                        Grafiken). Durch diese Web Beacons können Informationen
                        wie der Besucherverkehr auf diesen Seiten ausgewertet
                        ...
                        Werbeformaten werden an einen Server von Google in den
                        USA übertragen und dort gespeichert. Diese Informationen
                        können von Google an Vertragspartner von Google weiter
                        gegeben werden. Google wird Ihre IP-Adresse jedoch nicht
                        mit anderen von Ihnen gespeicherten Daten
                        zusammenführen. Die Speicherung von AdSense-Cookies
                        erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
                        Der Websitebetreiber hat ein berechtigtes Interesse an
                        der Analyse des Nutzerverhaltens, um sowohl sein
                        Webangebot als auch seine Werbung zu optimieren. Sie
                    ...
                    <p>
                        ...
                        Conversion-Tracking. Wenn Sie auf eine von Google
                        geschaltete Anzeige klicken wird ein Cookie für das
                        Conversion-Tracking gesetzt. Bei Cookies handelt es sich
                        um kleine Textdateien, die der Internet-Browser auf dem
                        Computer des Nutzers ablegt. Diese Cookies verlieren
                        nach 30 Tagen ihre Gültigkeit und dienen nicht der
                        persönlichen Identifizierung der Nutzer. Besucht der
                        Nutzer bestimmte Seiten dieser Website und das Cookie
                        ist noch nicht abgelaufen, können Google und wir
                        erkennen, dass der Nutzer auf die Anzeige geklickt hat
                        und zu dieser Seite weitergeleitet wurde.
                    </p>{" "}
                    <p>
                        Jeder Google AdWords-Kunde erhält ein anderes Cookie.
                        Die Cookies können nicht über die Websites von
                        AdWords-Kunden nachverfolgt werden. Die mithilfe des
                        Conversion-Cookies eingeholten Informationen dienen
                        dazu, Conversion-Statistiken für AdWords-Kunden zu
                        erstellen, die sich für Conversion-Tracking entschieden
                        haben. Die Kunden erfahren die Gesamtanzahl der Nutzer,
                        die auf ihre Anzeige geklickt haben und zu einer mit
                        ...
                        identifizieren lassen. Wenn Sie nicht am Tracking
                        ...
                        Nutzereinstellungen leicht deaktivieren. Sie werden
                        sodann nicht in die Conversion-Tracking Statistiken
                        aufgenommen.
                    </p>{" "}
                    <p>
                        Die Speicherung von „Conversion-Cookies“ und die Nutzung
                        dieses Tracking-Tools erfolgen auf Grundlage von Art. 6
                        Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein
                        berechtigtes Interesse an der Analyse des
                        Nutzerverhaltens, um sowohl sein Webangebot als auch
                        seine Werbung zu optimieren.
                    ...
                    <h5>IONOS WebAnalytics</h5>{" "}
                    <p>
                        Diese Website nutzt die Analysedienste von IONOS
                        WebAnalytics (im Folgenden: IONOS). Anbieter ist die
                        1&amp;1 IONOS SE, Elgendorfer Straße 57, D – 56410
                        Montabaur. Im Rahmen der Analysen mit IONOS können u. a.
                        Besucherzahlen und –verhalten (z. B. Anzahl der
                        Seitenaufrufe, Dauer eines Webseitenbesuchs,
                        Absprungraten), Besucherquellen (d. h., von welcher
                        Seite der Besucher kommt), Besucherstandorte sowie
                        technische Daten (Browser- und Betriebssystemversionen)
                        analysiert werden. Zu diesem Zweck speichert IONOS
                    ...
                    <p>
                        ...
                        statistischen Analyse des Nutzerverhaltens, um sowohl
                        sein Webangebot als auch seine Werbung zu optimieren.
                        Sofern eine entsprechende Einwilligung abgefragt wurde,
                        erfolgt die Verarbeitung ausschließlich auf Grundlage
                        von Art. 6 Abs. 1 lit. a DSGVO; die Einwilligung ist
                        jederzeit widerrufbar.
                    </p>{" "}
                    <p>
                        Weitere Informationen zur Datenerfassung und
                        Verarbeitung durch IONOS WebAnalytics entnehmen Sie der
                    ...
                    <p>
                        <a
                            ...
                            target="_blank"
                            rel="noopener"
                            title="Datenschutzerklärung IONOS Website - IONOS AGB"
                        >
                    ...
                    <h6>Auftragsverarbeitung</h6>{" "}
                    <p>
                        Wir haben mit IONOS einen Vertrag zur
                        Auftragsverarbeitung abgeschlossen. Dieser Vertrag soll
                        den datenschutzkonformen Umgang mit Ihren
                    ...
                    <p>
                        ...
                        die Automattic Inc., 60 29th Street #343, San Francisco,
                        CA 94110-4929, USA.
                    </p>{" "}
                    <p>
                        WordPress Stats verwendet Cookies, die auf Ihrem
                        Computer gespeichert werden und die eine Analyse der
                        Benutzung der Website erlauben. Die durch die Cookies
                        generierten Informationen über die Benutzung unserer
                        Website werden auf Servern in den USA gespeichert. Ihre
                        IP-Adresse wird nach der Verarbeitung und vor der
                        Speicherung anonymisiert.
                    </p>{" "}
                    <p>
                        „WordPress-Stats“-Cookies verbleiben auf Ihrem Endgerät,
                        bis Sie sie löschen. Die Speicherung von „WordPress
                        Stats“-Cookies und die Nutzung dieses Analyse-Tools
                        erfolgen auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
                        Der Websitebetreiber hat ein berechtigtes Interesse an
                        der anonymisierten Analyse des Nutzerverhaltens, um
                    ...
                    <p>
                        ...
                        Besucheraktions-Pixel von Facebook, Facebook Inc., 1601
                        S. California Ave, Palo Alto, CA 94304, USA
                        („Facebook“).
                    </p>{" "}
                    <p>
                        So kann das Verhalten der Seitenbesucher nachverfolgt
                        werden, nachdem diese durch Klick auf eine
                        Facebook-Werbeanzeige auf die Website des Anbieters
                        weitergeleitet wurden. Dadurch können die Wirksamkeit
                    ...
                    <p>
                        ...
                        Website anonym, wir können keine Rückschlüsse auf die
                        Identität der Nutzer ziehen. Die Daten werden aber von
                        Facebook gespeichert und verarbeitet, sodass eine
                        Verbindung zum jeweiligen Nutzerprofil möglich ist und
                        Facebook die Daten für eigene Werbezwecke, entsprechend
                        der{" "}
                        <a
                            href="https://de-de.facebook.com/about/privacy/"
                            target="_blank"
                        ...
                        Werbeanzeigen auf Seiten von Facebook sowie außerhalb
                        von Facebook ermöglichen. Diese Verwendung der Daten
                        kann von uns als Seitenbetreiber nicht beeinflusst
                        werden.
                    </p>{" "}
                    <p>
                        Die Nutzung von Facebook-Pixel erfolgt auf Grundlage von
                        Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein
                        berechtigtes Interesse an effektiven Werbemaßnahmen
                        unter Einschluss der sozialen Medien.
                    </p>{" "}
                    <p>
                        In den Datenschutzhinweisen von Facebook finden Sie
                    ...
                    <p>
                        ...
                        Audiences“ im Bereich Einstellungen für Werbeanzeigen
                        unter{" "}
                        <a
                        ...
                        deaktivieren. Dazu müssen Sie bei Facebook angemeldet
                        sein.
                    </p>{" "}
                    <p>
                        Wenn Sie kein Facebook Konto besitzen, können Sie
                        nutzungsbasierte Werbung von Facebook auf der Website
                    ...
                    <p>
                        ...
                        Newsletters einverstanden sind. Weitere Daten werden
                        nicht bzw. nur auf freiwilliger Basis erhoben. Diese
                    ...
                    <p>
                        ...
                        Newsletters können Sie jederzeit widerrufen, etwa über
                        den „Austragen“-Link im Newsletter. Die Rechtmäßigkeit
                        der bereits erfolgten Datenverarbeitungsvorgänge bleibt
                    ...
                    <p>
                        ...
                        Abbestellung des Newsletters gelöscht. Daten, die zu
                        anderen Zwecken bei uns gespeichert wurden bleiben
                        hiervon unberührt.
                    </p>{" "}
                    <h4>8. Eigene Dienste</h4>
                    <h5>Bewerbungen</h5>{" "}
                    <p>
                        Wir bieten Ihnen die Möglichkeit, sich bei uns zu
                        bewerben (z.&nbsp;B. per E-Mail, postalisch oder via
                        Online-Bewerberformular). Im Folgenden informieren wir
                        Sie über Umfang, Zweck und Verwendung Ihrer im Rahmen
                        des Bewerbungsprozesses erhobenen personenbezogenen
                        Daten. Wir versichern, dass die Erhebung, Verarbeitung
                        und Nutzung Ihrer Daten in Übereinstimmung mit geltendem
                        Datenschutzrecht und allen weiteren gesetzlichen
                        Bestimmungen erfolgt und Ihre Daten streng vertraulich
                        behandelt werden.
                    </p>{" "}
                    <h6>Umfang und Zweck der Datenerhebung</h6>{" "}
                    <p>
                        Wenn Sie uns eine Bewerbung zukommen lassen, verarbeiten
                        wir Ihre damit verbundenen personenbezogenen Daten
                        (z.&nbsp;B. Kontakt- und Kommunikationsdaten,
                        Bewerbungsunterlagen, Notizen im Rahmen von
                        Bewerbungsgesprächen etc.), soweit dies zur Entscheidung
                        über die Begründung eines Beschäftigungsverhältnisses
                        erforderlich ist. Rechtsgrundlage hierfür ist § 26
                        BDSG-neu nach deutschem Recht (Anbahnung eines
                        Beschäftigungsverhältnisses), Art. 6 Abs. 1 lit. b DSGVO
                        (allgemeine Vertragsanbahnung) und – sofern Sie eine
                        Einwilligung erteilt haben – Art. 6 Abs. 1 lit. a DSGVO.
                        Die Einwilligung ist jederzeit widerrufbar. Ihre
                        personenbezogenen Daten werden innerhalb unseres
                        Unternehmens ausschließlich an Personen weitergegeben,
                        die an der Bearbeitung Ihrer Bewerbung beteiligt sind.
                    </p>{" "}
                    <p>
                        Sofern die Bewerbung erfolgreich ist, werden die von
                        Ihnen eingereichten Daten auf Grundlage von § 26
                        BDSG-neu und Art. 6 Abs. 1 lit. b DSGVO zum Zwecke der
                    ...
                    <p>
                        Wenn wir Ihnen kein Stellenangebot machen können, Sie
                        ein Stellenangebot ablehnen, Ihre Bewerbung
                        zurückziehen, Ihre Einwilligung zur Datenverarbeitung
                        widerrufen oder uns zur Löschung der Daten auffordern,
                        werden die von Ihnen übermittelten Daten inkl. ggf.
                        verbleibender physischer Bewerbungsunterlagen für
                        maximal 6 Monate nach Abschluss des Bewerbungsverfahrens
                        gespeichert bzw. aufbewahrt (Aufbewahrungsfrist), um die
                        Einzelheiten des Bewerbungsprozesses im Falle von
                        Unstimmigkeiten nachvollziehen zu können (Art. 6 Abs. 1
                        lit. f DSGVO).
                    </p>{" "}
                    <p>
                        DIESER SPEICHERUNG KÖNNEN SIE WIDERSPRECHEN, SOFERN
                        IHRERSEITS BERECHTIGTE INTERESSEN VORLIEGEN, DIE UNSERE
                        INTERESSEN ÜBERWIEGEN.
                    </p>{" "}
                    <p>
                        Nach Ablauf der Aufbewahrungsfrist werden die Daten
                        gelöscht, sofern keine gesetzliche Aufbewahrungspflicht
                        oder ein sonstiger Rechtsgrund zur weiteren Speicherung
                        vorliegt. Sofern ersichtlich ist, dass die Aufbewahrung
                        Ihrer Daten nach Ablauf der Aufbewahrungsfrist
                        erforderlich sein wird (z.&nbsp;B. aufgrund eines
                        drohenden oder anhängigen Rechtsstreits), findet eine
                        Löschung erst statt, wenn die Daten gegenstandslos
                        geworden sind. Sonstige gesetzliche
                        Aufbewahrungspflichten bleiben unberührt.
                    </p>{" "}
                    <h4>9. Online Marketing und Partnerprogramme</h4>
                    <h5>Amazon Partnerprogramm</h5>{" "}
                    <p>
                        Die Betreiber der Seiten nehmen am Amazon EU-
                        Partnerprogramm teil. Auf unseren Seiten werden durch
                        Amazon Werbeanzeigen und Links zur Seite von Amazon.de
                        eingebunden, an denen wir über 23 / 27
                        Werbekostenerstattung Geld verdienen können. Amazon
                        setzt dazu Cookies ein, um die Herkunft der Bestellungen
                        nachvollziehen zu können. Dadurch kann Amazon erkennen,
                        dass Sie den Partnerlink auf unserer Website geklickt
                        haben. Die Speicherung von „Amazon-Cookies“ erfolgt auf
                        Grundlage von Art. 6 lit. f DSGVO. Der Websitebetreiber
                        hat hieran ein berechtigtes Interesse, da nur durch die
                        Cookies die Höhe seiner Affiliate-Vergütung feststellbar
                        ist. Weitere Informationen zur Datennutzung durch Amazon
                    ...
                    <h4>10. Zahlungsanbieter und Reseller</h4>
                    <h5>PayPal</h5>{" "}
                    <p>
                        Auf unserer Website bieten wir u.a. die Bezahlung via
                        PayPal an. Anbieter dieses Zahlungsdienstes ist die
                        PayPal (Europe) S.à.r.l. et Cie, S.C.A., 22-24 Boulevard
                        Royal, L-2449 Luxembourg (im Folgenden „PayPal“).
                    </p>{" "}
                    <p>
                        Wenn Sie die Bezahlung via PayPal auswählen, werden die
                        von Ihnen eingegebenen Zahlungsdaten an PayPal
                        übermittelt.
                    </p>{" "}
                    <p>
                        Die Übermittlung Ihrer Daten an PayPal erfolgt auf
                        Grundlage von Art. 6 Abs. 1 lit. a DSGVO (Einwilligung)
                        und Art. 6 Abs. 1 lit. b DSGVO (Verarbeitung zur
                        Erfüllung eines Vertrags). Sie haben die Möglichkeit,
                        Ihre Einwilligung zur Datenverarbeitung jederzeit zu
                        widerrufen. Ein Widerruf wirkt sich auf die Wirksamkeit
                        von in der Vergangenheit liegenden
                        Datenverarbeitungsvorgängen nicht aus.
                    </p>{" "}
                    <h5>Klarna</h5>{" "}
                    <p>
                        Auf unserer Website bieten wir u.a. die Bezahlung mit
                        den Diensten von Klarna an. Anbieter ist die Klarna AB,
                        Sveavägen 46, 111 34 Stockholm, Schweden (im Folgenden
                        „Klarna“).
                    </p>{" "}
                    <p>
                        Klarna bietet verschiedene Zahlungsoptionen an
                        (z.&nbsp;B. Ratenkauf). Wenn Sie sich für die Bezahlung
                        mit Klarna entscheiden (Klarna-Checkout-Lösung), wird
                        Klarna verschiedene personenbezogene Daten von Ihnen
                        erheben. Details hierzu können Sie in der
                        Datenschutzerklärung von Klarna unter folgendem Link
                        nachlesen:{" "}
                        <a
                    ...
                    <p>
                        Klarna nutzt Cookies, um die Verwendung der
                        Klarna-Checkout-Lösung zu optimieren. Die Optimierung
                        der Checkout-Lösung stellt ein berechtigtes Interesse im
                        Sinne von Art. 6 Abs. 1 lit. f DSGVO dar. Cookies sind
                        kleine Textdateien, die auf Ihrem Endgerät gespeichert
                        werden und keinen Schaden anrichten. Sie verbleiben auf
                        Ihrem Endgerät bis Sie sie löschen. Details zum Einsatz
                        von Klarna-Cookies entnehmen Sie folgendem Link:{" "}
                        <a
                    ...
                    <p>
                        Die Übermittlung Ihrer Daten an Klarna erfolgt auf
                        Grundlage von Art. 6 Abs. 1 lit. a DSGVO (Einwilligung)
                        und Art. 6 Abs. 1 lit. b DSGVO (Verarbeitung zur
                        Erfüllung eines Vertrags). Sie haben die Möglichkeit,
                        Ihre Einwilligung zur Datenverarbeitung jederzeit zu
                    ...
                    <p>
                        ...
                        mittels „Sofortüberweisung“ an. Anbieter dieses
                        Zahlungsdienstes ist die Sofort GmbH, Theresienhöhe 12,
                        80339 München (im Folgenden „Sofort GmbH“).
                    </p>{" "}
                    <p>
                        Mit Hilfe des Verfahrens „Sofortüberweisung“ erhalten
                        wir in Echtzeit eine Zahlungsbestätigung von der Sofort
                        GmbH und können unverzüglich mit der Erfüllung unserer
                        Verbindlichkeiten beginnen.
                    </p>{" "}
                    <p>
                        Wenn Sie sich für die Zahlungsart „Sofortüberweisung“
                        entschieden haben, übermitteln Sie die PIN und eine
                        gültige TAN an die Sofort GmbH, mit der diese sich in
                        Ihr Online-Banking-Konto einloggen kann. Sofort GmbH
                        überprüft nach dem Einloggen automatisch Ihren
                        Kontostand und führt die Überweisung an uns mit Hilfe
                        der von Ihnen übermittelten TAN durch. Anschließend
                        übermittelt sie uns unverzüglich eine
                        Transaktionsbestätigung. Nach dem Einloggen werden
                        außerdem Ihre Umsätze, der Kreditrahmen des Dispokredits
                        und das Vorhandensein anderer Konten sowie deren
                        Bestände automatisiert geprüft.
                    </p>{" "}
                    <p>
                        Neben der PIN und der TAN werden auch die von Ihnen
                        eingegebenen Zahlungsdaten sowie Daten zu Ihrer Person
                        an die Sofort GmbH übermittelt. Bei den Daten zu Ihrer
                        Person handelt es sich um Vor- und Nachname, Adresse,
                        Telefonnummer(n), Email-Adresse, IP-Adresse und ggf.
                        weitere zur Zahlungsabwicklung erforderliche Daten. Die
                        Übermittlung dieser Daten ist notwendig, um Ihre
                        Identität zweifelsfrei zu festzustellen und
                        Betrugsversuchen vorzubeugen.
                    </p>{" "}
                    <p>
                        Die Übermittlung Ihrer Daten an die Sofort GmbH erfolgt
                        auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO
                        (Einwilligung) und Art. 6 Abs. 1 lit. b DSGVO
                        (Verarbeitung zur Erfüllung eines Vertrags). Sie haben
                        die Möglichkeit, Ihre Einwilligung zur Datenverarbeitung
                        jederzeit zu widerrufen. Ein Widerruf wirkt sich auf die
                        Wirksamkeit von in der Vergangenheit liegenden
                        Datenverarbeitungsvorgängen nicht aus.
                    </p>{" "}
                    <p>
                        Details zur Zahlung mit Sofortüberweisung entnehmen Sie
                        folgenden Links:{" "}
                        <a
                    ...
                    <p>
                        Auf unserer Website bieten wir u.a. die Bezahlung
                        mittels Paydirekt an. Anbieter dieses Zahlungsdienstes
                        ist die Paydirekt GmbH, Hamburger Allee 26-28, 60486
                        Frankfurt am Main, Deutschland (im Folgenden
                        „Paydirekt“).
                    </p>{" "}
                    <p>
                        Wenn Sie die Bezahlung mittels Paydirekt ausführen,
                        erhebt Paydirekt verschiedene Transaktionsdaten und
                        leitet diese an die Bank weiter, bei der Sie mit
                        Paydirekt registriert sind. Neben den für die Zahlung
                        erforderlichen Daten erhebt Paydirekt im Rahmen der
                        Transaktionsabwicklung ggf. weitere Daten wie z.&nbsp;B.
                        Lieferadresse oder einzelne Positionen im Warenkorb.
                    </p>{" "}
                    <p>
                        Paydirekt authentifiziert die Transaktion anschließend
                        mit Hilfe des bei der Bank hierfür hinterlegten
                        Authentifizierungsverfahrens. Anschließend wird der
                        Zahlbetrag von Ihrem Konto auf unser Konto überwiesen.
                        Weder wir noch Dritte haben Zugriff auf Ihre Kontodaten.
                    </p>{" "}
                    <p>
                        Details zur Zahlung mit Paydirekt entnehmen Sie den AGB
                        und den Datenschutzbestimmungen von Paydirekt unter:{" "}
                        <a
                    ...
                    <p>
                        Wir unterhalten öffentlich zugängliche Profile in
                        sozialen Netzwerken. Die im Einzelnen von uns genutzten
                        sozialen Netzwerke finden Sie weiter unten.
                    </p>{" "}
                    <p>
                        Soziale Netzwerke wie Facebook, Google+ etc. können Ihr
                        Nutzerverhalten in der Regel umfassend analysieren, wenn
                        Sie deren Webseite oder eine Webseite mit integrierten
                        Social-Media-Inhalten (z.&nbsp;B. Like-Buttons oder
                        Werbebannern) besuchen. Durch den Besuch unserer
                        Social-Media-Präsenzen werden zahlreiche
                        datenschutzrelevante Verarbeitungsvorgänge ausgelöst. Im
                        Einzelnen:
                    </p>{" "}
                    <p>
                        Wenn Sie in Ihrem Social-Media-Account eingeloggt sind
                        und unsere Social-Media-Präsenz besuchen, kann der
                        Betreiber des Social-Media-Portals diesen Besuch Ihrem
                        Benutzerkonto zuordnen. Ihre personenbezogenen Daten
                        können unter Umständen aber auch dann erfasst werden,
                        wenn Sie nicht eingeloggt sind oder keinen Account beim
                        jeweiligen Social-Media-Portal besitzen. Diese
                        Datenerfassung erfolgt in diesem Fall beispielsweise
                        über Cookies, die auf Ihrem Endgerät gespeichert werden
                        oder durch Erfassung Ihrer IP-Adresse.
                    </p>{" "}
                    <p>
                        Mit Hilfe der so erfassten Daten können die Betreiber
                        der Social-Media-Portale Nutzerprofile erstellen, in
                        denen Ihre Präferenzen und Interessen hinterlegt sind.
                        Auf diese Weise kann Ihnen interessenbezogene Werbung
                        in- und außerhalb der jeweiligen Social-Media-Präsenz
                        angezeigt werden. Sofern Sie über einen Account beim
                        jeweiligen sozialen Netzwerk verfügen, kann die
                        interessenbezogene Werbung auf allen Geräten angezeigt
                        werden, auf denen Sie eingeloggt sind oder eingeloggt
                        waren.
                    </p>{" "}
                    <p>
                        Bitte beachten Sie außerdem, dass wir nicht alle
                        Verarbeitungsprozesse auf den Social-Media-Portalen
                        nachvollziehen können. Je nach Anbieter können daher
                        ggf. weitere Verarbeitungsvorgänge von den Betreibern
                        der Social-Media-Portale durchgeführt werden. Details
                        hierzu entnehmen Sie den Nutzungsbedingungen und
                        Datenschutzbestimmungen der jeweiligen
                        Social-Media-Portale.
                    </p>{" "}
                    <p>
                        <strong>Rechtsgrundlage</strong>
                        <br /> Unsere Social-Media-Auftritte sollen eine
                        möglichst umfassende Präsenz im Internet gewährleisten.
                        Hierbei handelt es sich um ein berechtigtes Interesse im
                        Sinne von Art. 6 Abs. 1 lit. f DSGVO. Die von den
                        sozialen Netzwerken initiierten Analyseprozesse beruhen
                        ggf. auf abweichenden Rechtsgrundlagen, die von den
                        Betreibern der sozialen Netzwerke anzugeben sind
                        (z.&nbsp;B. Einwilligung im Sinne des Art. 6 Abs. 1 lit.
                        a DSGVO).
                    </p>{" "}
                    <p>
                        <strong>
                        ...
                        <br /> Wenn Sie einen unserer Social-Media-Auftritte
                        (z.&nbsp;B. Facebook) besuchen, sind wir gemeinsam mit
                        dem Betreiber der Social-Media-Plattform für die bei
                        diesem Besuch ausgelösten Datenverarbeitungsvorgänge
                        verantwortlich. Sie können Ihre Rechte (Auskunft,
                        Berichtigung, Löschung, Einschränkung der Verarbeitung,
                        Datenübertragbarkeit und Beschwerde) grundsätzlich
                        sowohl ggü. uns als auch ggü. dem Betreiber des
                        jeweiligen Social-Media-Portals (z.&nbsp;B. ggü.
                        Facebook) geltend machen.
                    </p>{" "}
                    <p>
                        Bitte beachten Sie, dass wir trotz der gemeinsamen
                        Verantwortlichkeit mit den
                        Social-Media-Portal-Betreibern nicht vollumfänglich
                        Einfluss auf die Datenverarbeitungsvorgänge der
                        Social-Media-Portale haben. Unsere Möglichkeiten richten
                        sich maßgeblich nach der Unternehmenspolitik des
                        jeweiligen Anbieters.
                    </p>{" "}
                    <p>
                        <strong>Speicherdauer</strong>
                        <br /> Die unmittelbar von uns über die
                        Social-Media-Präsenz erfassten Daten werden von unseren
                        Systemen gelöscht, sobald der Zweck für ihre Speicherung
                        entfällt, Sie uns zur Löschung auffordern, Ihre
                        Einwilligung zur Speicherung widerrufen oder der Zweck
                        für die Datenspeicherung entfällt. Gespeicherte Cookies
                        verbleiben auf Ihrem Endgerät, bis Sie sie löschen.
                        Zwingende gesetzliche Bestimmungen – insb.
                        Aufbewahrungsfristen – bleiben unberührt.
                    </p>{" "}
                    <p>
                        Auf die Speicherdauer Ihrer Daten, die von den
                        Betreibern der sozialen Netzwerke zu eigenen Zwecken
                        gespeichert werden, haben wir keinen Einfluss. Für
                        Einzelheiten dazu informieren Sie sich bitte direkt bei
                        den Betreibern der sozialen Netzwerke (z.&nbsp;B. in
                        deren Datenschutzerklärung, siehe unten).
                    </p>{" "}
                    <h5>Soziale Netzwerke im Einzelnen</h5> <h5>Facebook</h5>{" "}
                    <p>
                        Wir verfügen über ein Profil bei Facebook. Anbieter ist
                        die Facebook Inc., 1 Hacker Way, Menlo Park, California
                        94025, USA. Facebook verfügt über eine Zertifizierung
                        nach dem EU-US-Privacy-Shield.
                    </p>{" "}
                    <p>
                        Wir haben mit Facebook eine Vereinbarung über gemeinsame
                        Verarbeitung (Controller Addendum) geschlossen. In
                        dieser Vereinbarung wird festgelegt, für welche
                        Datenverarbeitungsvorgänge wir bzw. Facebook
                        verantwortlich ist, wenn Sie unsere Facebook-Page
                        besuchen. Diese Vereinbarung können Sie unter folgendem
                        Link einsehen:{" "}
                        <a
                    ...
                    <p>
                        <strong>
                            Sie können Ihre Werbeeinstellungen selbstständig in
                            Ihrem Nutzer-Account anpassen. Klicken Sie hierzu
                    ...
                    <p>
                        Facebook Ireland Ltd („Facebook“) stellt uns als
                        Facebook-Fanpage Betreiber sog. „Facebook-Insights“
                        („Insights“) zur Verfügung. Bei den Insights handelt es
                        sich um verschiedene Statistiken, die uns Aufschluss
                        über die Verwendung unserer Facebook-Fanpage geben.
                        Detaillierte Informationen hierzu und welche
                        Datenverarbeitung stattfindet, finden Sie unter{" "}
                        <a
                            href="https://www.facebook.com/business/a/page/page-insights"
                            target="_blank"
                            rel="noopener"
                            title="So verwaltest du deine Facebook-Unternehmensseiten | Facebook for Business"
                        >
                    ...
                    <p>
                        Facebook-Fanpage-Insights können auf personenbezogenen
                        Daten basieren, die im Zusammenhang mit einem Besuch
                        oder einer Interaktion von Personen auf bzw. mit unserer
                        Facebook-Fanpage und ihren Inhalten erfasst wurden, so
                        dass auch personenbezogene Daten durch Facebook
                        verarbeitet werden können, besuchen Sie unsere
                        Facebook-Site. Die wesentlichen Informationen der
                        zwischen uns und Facebook geschlossenen Vereinbarung im
                        Sinne von Artikel 26 Datenschutz-Grundverordnung finden
                        Sie dort:{" "}
                        <a
                            href="https://www.facebook.com/legal/terms/page_controller_addendum"
                            target="_blank"
                    ...
                    <p>
                        <strong>
                            Gemeinsam für die Verarbeitung verantwortlich
                        </strong>{" "}
                        Facebook-Fanpage Insights sind
                    </p>{" "}
                    <p>
                        {" "}
                        Facebook Ireland Ltd. <br /> 4 Grand Canal Square <br />{" "}
                        Grand Canal Harbour <br /> Dublin 2, Ireland <br />{" "}
                        <a
                            href="https://www.facebook.com/help/contact/2061665240770586"
                            target="_blank"
                            rel="noopener"
                            title="Fragen zur Datenrichtlinie"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener"
                            title="Kontaktiere den Datenschutzbeauftragten"
                        >
                    ...
                    <p>und</p>{" "}
                    <p>
                        Hecker Sonderfahrten e.K. <br /> Am Haldenberg 19 <br />{" "}
                        74564 Crailsheim <br /> Tel.{" "}
                        <span class="phone ">07951 / 3198270</span> <br /> Fax:
                        07951 / 3198269 <br /> E-Mail:{" "}
                        <a
                            href="mailto:info@hecker-sonderfahrten.de"
                            class="escape email "
                            title="Schreiben Sie Hecker Sonderfahrten e.K. in 74564 Crailsheim eine E-Mail."
                    ...
                    <ul>
                        {" "}
                        <li>
                            die Informationspflichten aus Artikeln 12, 13 DSGVO,
                            ebenso
                        </li>{" "}
                        <li>
                            die Verpflichtungen aus Artikel 15 bis 21 DSGVO, die
                            Betroffenenrechte können also gegenüber Facebook
                            Ireland geltend gemacht werden, sowie
                        </li>{" "}
                        <li>die Pflichten aus Artikel 33 und 34 DSGVO.</li>{" "}
                    </ul>{" "}
                    <p>
                        Selbstverständlich können Sie Ihre Rechte aber auch uns
                        gegenüber geltend machen.
                    </p>{" "}
                    <p>
                        Facebook Ireland trifft im Einklang mit Artikel 32 DSGVO
                        geeignete technische und organisatorische Maßnahmen, um
                        die Sicherheit der Verarbeitungen mittels Facebook
                        Fanpage Insights zu gewährleisten.
                    </p>{" "}
                    <p>
                        Rechtsgrundlage und Zwecke der Verarbeitung seitens
                        Facebook Ireland entnehmen Sie bitte den dortigen
                        Angaben:{" "}
                        <a
                    ...
                    <p>
                        Wir verarbeiten die Facebook Fanpage Insights Daten
                        aufgrund unseres berechtigen Interesse zur Auswertungen
                        der Aktivitäten auf unserer Fanpage und unserer
                        Marketingmaßnahmen dort (Werbeanzeigen, -Kampagnen,
                        -Postings); Artikel 6 Absatz 1 Satz 1 f) DSGVO.
                    </p>{" "}
                    <p>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener"
                            title="Datenschutz: Facebook nimmt Stellung zu Fanpages!"
                        >
                    ...
                    <p>
                        ...
                        Bereitstellung kann jedoch für einen Vertragsabschluss
                        oder für Funktionen der Facebook Fanpage erforderlich
                        sein. Bei einer Nichtbereitstellung kann also
                        gegebenenfalls ein Vertrag oder eine Funktion auf der
                        Facebook Fanpage nicht angeboten werden.
                    </p>{" "}
                    <p>
                        Die Rechte von betroffenen Personen ergeben sich
                        insbesondere aus Artikel 15 bis 23 und Artikel 77
                        Datenschutzgrundverordnung sowie aus §§ 32 bis 37
                        Bundesdatenschutzgesetz.
                    </p>{" "}
                    <p>
                        Sie haben im Hinblick auf Ihre personenbezogenen Daten
                        das Recht auf
                    </p>{" "}
                    <ul>
                        {" "}
                    ...
                    <p>
                        zu erheben, siehe weitere Informationen gesondert
                        sogleich.
                    </p>{" "}
                    <p>
                        Wenn Sie eine Einwilligung zur Verarbeitung von
                        personenbezogenen Daten erteilt haben, haben Sie das
                        Recht des
                    </p>{" "}
                    <ul>
                        {" "}
                    ...
                    <p>
                        Alle Anfragen, Aufforderungen und Mitteilungen richten
                        Sie bitte an Facebook Ireland oder an uns, siehe oben-
                    </p>{" "}
                    <p>
                        Sind Sie der Ansicht, dass die Verarbeitung der Sie
                        betreffenden personenbezogenen Daten gegen das
                        Datenschutzrecht verstößt, haben Sie stets das
                    </p>{" "}
                    <ul>
                        {" "}
                    ...
                    <p>
                        ...
                        Datenschutzgrundverordnung. Unbeschadet eines
                        anderweitigen verwaltungsrechtlichen oder gerichtlichen
                        Rechtsbehelfs steht Ihnen dieses Recht auf Beschwerde
                        bei einer Aufsichtsbehörde, insbesondere in dem
                        ...
                        Datenschutzgrundverordnung verstößt. Die für Facebook
                        Ireland zuständige Aufsichtsbehörde ist die irische
                        Datenschutzkommission (
                        <a
                            href="https://www.dataprotection.ie/"
                            target="_blank"
                            rel="noopener"
                            title="Homepage | Data Protection Commission"
                        >
                            https://www.dataprotection.ie/
                        </a>
                        ) für uns ist zuständig die Landesbeauftragte für
                        Datenschutz und Informationsfreiheit
                        Nordrhein-Westfalen, Kavalleriestraße 2-4, 40213
                        Düsseldorf.
                    </p>{" "}
                    <p>
                    ...
                    <p>
                        1. Sie haben das Recht aus Gründen, die sich aus Ihrer
                        besonderen Situation ergeben, jederzeit gegen die
                        Verarbeitung Sie betreffender personenbezogener Daten
                        Widerspruch einzulegen, die aufgrund von Artikel 6
                        Absatz 1 Satz 1 f) Datenschutzgrundverordnung
                    ...
                    <p>
                        2. In Einzelfällen verarbeiten wir personenbezogene
                        Daten, um Direktwerbung zu betreiben. Ist dies bei Ihnen
                        der Fall, haben Sie das Recht, jederzeit Widerspruch
                        gegen die Verarbeitung Sie betreffender Daten zum Zwecke
                    ...
                    <h5>Google+</h5>{" "}
                    <p>
                        Wir verfügen über ein Profil bei Google+. Anbieter ist
                        die Google Ireland Limited („Google“), Gordon House,
                        Barrow Street, Dublin 4, Irland. Google verfügt über
                    ...
                    <h5>Twitter</h5>{" "}
                    <p>
                        Wir nutzen den Kurznachrichtendienst Twitter. Anbieter
                        ist die Twitter Inc., 1355 Market Street, Suite 900, San
                        Francisco, CA 94103, USA. Twitter verfügt über eine
                        Zertifizierung nach dem EU-US-Privacy-Shield.
                    </p>{" "}
                    <p>
                        <strong>
                            Sie können Ihre Twitter-Datenschutzeinstellungen
                            selbstständig in Ihrem Nutzer-Account anpassen.
                            Klicken Sie hierzu auf folgenden Link und loggen Sie
                            sich ein:
                        </strong>{" "}
                        <a
                    ...
                    <h5>Instagram</h5>{" "}
                    <p>
                        Wir verfügen über ein Profil bei Instagram. Anbieter ist
                        die Instagram Inc., 1601 Willow Road, Menlo Park, CA,
                        94025, USA. Details zu deren Umgang mit Ihren
                        personenbezogenen Daten entnehmen Sie der
                        Datenschutzerklärung von Instagram:{" "}
                        <a
                    ...
                    <p>
                        ...
                        ist die Pinterest Inc., 808 Brannan Street San
                        Francisco, CA 94103-490, USA („Pinterest“). Details zu
                        deren Umgang mit Ihren personenbezogenen Daten entnehmen
                        Sie der Datenschutzerklärung von Pinterest:{" "}
                        <a
                            href="https://policy.pinterest.com/de/privacy-policy"
                            target="_blank"
                            rel="noopener"
                    ...
                    <p>
                        ...
                        Deutschland. Details zu deren Umgang mit Ihren
                        personenbezogenen Daten entnehmen Sie der
                    ...
                    <h5>LinkedIn</h5>{" "}
                    <p>
                        Wir verfügen über ein Profil bei LinkedIn. Anbieter ist
                        die LinkedIn Ireland Unlimited Company
                        <strong>, </strong>Wilton Plaza, Wilton Place, Dublin
                        2,&nbsp;Irland. LinkedIn verfügt über eine
                        Zertifizierung nach dem EU-US-Privacy-Shield. LinkedIn
                        verwendet Werbecookies.
                    </p>{" "}
                    <p>
                        <strong>
                            Wenn Sie LinkedIn-Werbe-Cookies deaktivieren
                            möchten, nutzen Sie bitte folgenden Link:{" "}
                        </strong>
                        <a
                    ...
                    <p>
                        Details zu deren Umgang mit Ihren personenbezogenen
                        Daten entnehmen Sie der Datenschutzerklärung von
                        LinkedIn:{" "}
                        <a
                            href="https://www.linkedin.com/legal/privacy-policy"
                            target="_blank"
                    ...
                    <h5>Tumblr</h5>{" "}
                    <p>
                        Wir verfügen über ein Profil bei Tumblr. Anbieter ist
                        die Tumblr, Inc., 35 East 21st St, 10th Floor, New York,
                        NY 10010, USA. Details zu deren Umgang mit Ihren
                        personenbezogenen Daten entnehmen Sie der
